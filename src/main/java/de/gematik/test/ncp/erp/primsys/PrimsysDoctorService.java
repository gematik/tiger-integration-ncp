...
public interface PrimsysDoctorService {
   ...
   */
  PrescriptionDto issuePrescription(PrescribeRequestDto prescribeRequestDto);
   ...
   * @return the issued prescription
   */
  PrescriptionDto issuePrescription(Boolean direct, PrescribeRequestDto prescribeRequestDto);
}
