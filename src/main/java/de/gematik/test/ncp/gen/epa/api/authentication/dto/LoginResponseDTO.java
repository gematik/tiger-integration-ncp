...
package de.gematik.test.ncp.gen.epa.api.authentication.dto;
...
/** Returns the telematikId of the user that has logged in */
@ApiModel(description = "Returns the telematikId of the user that has logged in")
public class LoginResponseDTO {
  ...
  public LoginResponseDTO telematikId(String telematikId) {
    this.telematikId = telematikId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, loginResponseDTO.success)
        ...
        && Objects.equals(this.telematikId, loginResponseDTO.telematikId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, statusMessage, telematikId);
  }
