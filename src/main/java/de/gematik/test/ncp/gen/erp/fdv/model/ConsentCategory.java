...
/** Gets or Sets ConsentCategory */
public enum ConsentCategory {
  CHARGCONS("CHARGCONS"),

  EUDISPCONS("EUDISPCONS");

  private String value;

  ConsentCategory(String value) {
    this.value = value;
  }
   ...
   */
  public static ConsentCategory fromString(String s) {
    for (ConsentCategory b : ConsentCategory.values()) {
  ...
  @JsonCreator
  public static ConsentCategory fromValue(String value) {
    for (ConsentCategory b : ConsentCategory.values()) {
