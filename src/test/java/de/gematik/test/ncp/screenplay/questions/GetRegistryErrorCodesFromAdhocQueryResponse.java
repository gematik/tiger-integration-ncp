...
public class GetRegistryErrorCodesFromAdhocQueryResponse implements Question<Collection<String>> {
  ...
  public Collection<String> answeredBy(final Actor actor) {
    ...
    return DataUtils.readRegistryErrorCodesFromAdhocQueryResponse(
        patientRecord.getPsaDocumentMetadata());
  }
}
