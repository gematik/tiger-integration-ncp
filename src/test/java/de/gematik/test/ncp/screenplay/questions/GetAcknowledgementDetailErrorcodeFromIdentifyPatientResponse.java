...
public class GetAcknowledgementDetailErrorcodeFromIdentifyPatientResponse
    implements Question<String> {

  @Override
  public String answeredBy(final Actor actor) {
    return Optional.ofNullable(getAcknowledgementDetail(actor))
        .map(AcknowledgementDetail::code)
        .orElse(null);
  }

  public static AcknowledgementDetail getAcknowledgementDetail(final Actor actor) {
    ...
    return DataUtils.readAcknowledgementDetailFromIdentifyPatientResponse(
