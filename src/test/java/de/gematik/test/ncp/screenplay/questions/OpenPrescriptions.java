...
public class OpenPrescriptions implements Question<List<PrescriptionDto>> {

  private final Actor patient;

  @Override
  public List<PrescriptionDto> answeredBy(final Actor actor) {
    ...
    return client.getPrescribed(patientData.kvnr());
  }

  public static OpenPrescriptions forPatient(final Actor patient) {
    return new OpenPrescriptions(patient);
  }
}
