...
public class GetRetrievedPatientSummaryDocuments implements Question<Collection<DocumentResponse>> {

  @Override
  public Collection<DocumentResponse> answeredBy(final Actor actor) {
