...
@Slf4j
public class RetrievedPatientSummaryDocumentsIsOfLevel implements Question<Boolean> {

  private final Integer level;

  public RetrievedPatientSummaryDocumentsIsOfLevel(final Integer level) {
    this.level = level;
  }
  ...
  public static RetrievedPatientSummaryDocumentsIsOfLevel ofLevel(final Integer level) {
    return new RetrievedPatientSummaryDocumentsIsOfLevel(level);
  }
}
