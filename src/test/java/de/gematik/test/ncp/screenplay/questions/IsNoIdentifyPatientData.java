...
public class IsNoIdentifyPatientData implements Question<Boolean> {
  ...
  public Boolean answeredBy(final Actor actor) {
    ...
    return patientData.getIdentifyPatientData() == null
        && patientData.getIdentifyPatientDataResponse() != null;
  }
}
