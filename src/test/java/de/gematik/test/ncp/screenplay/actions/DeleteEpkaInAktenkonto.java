...
public class DeleteEpkaInAktenkonto implements Performable {
  @Override
  public <T extends Actor> void performAs(final T actor) {
    ...
    final var epkas = ps.findEpka(patientData.kvnr());
    if (!epkas.isEmpty()) {
      ps.deleteExistingDocuments(patientData.kvnr(), epkas);
    }
  ...
  public static DeleteEpkaInAktenkonto instance() {
    return Instrumented.instanceOf(DeleteEpkaInAktenkonto.class).newInstance();
  }
}
