...
@Slf4j
public class GetAllDocumentsFromAktenkonto implements Question<Collection<String>> {
  ...
  public Collection<String> answeredBy(final Actor actor) {
    ...
    log.debug("Found documents for kvnr {}: {}", kvnr, String.join(", ", documents));
    return documents;
  }

  public static GetAllDocumentsFromAktenkonto instance() {
    return Instrumented.instanceOf(GetAllDocumentsFromAktenkonto.class).newInstance();
  }
}
