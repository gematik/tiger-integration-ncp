...
public class RetrievedPatientSummaryDocumentsHcidBelongsToNcpeh implements Question<Boolean> {
  ...
  public Boolean answeredBy(final Actor actor) {
    ...
    return documents.stream()
        .allMatch(
            document ->
                document.getHomeCommunityId().endsWith(RetrieveDocumentRequestBuilder.NCPEH_HCID));
  }
}
