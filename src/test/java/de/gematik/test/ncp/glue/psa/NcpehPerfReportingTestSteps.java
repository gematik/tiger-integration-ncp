...
public class NcpehPerfReportingTestSteps {
  ...
  public void importTestcaseExecutionDataOfPerformanceUsecases(
      final DataTable performanceUsecaseTable) {
  ...
  public void importTestcaseExecutionDataOfNegativeUseCases(
      final DataTable performanceUsecaseTable) {
    // PerformanceUsecaseTable: | country | PerformanceUsecases (comma separated list) |
  ...
  public void checkStatusFieldOfPerformanceReportEntries(final DataTable expectedCodeRange) {
  ...
  public void checkPerformanceReportEntryForBackendduration() {
    ...
    // * its value is smaller than the own measured overall time of the operation and
    // * its value ist smaller than the sum of the reported duration (separate value outside the
    // message field)
    //   and reported backendduration
    // see https://gemspec.gematik.de/docs/gemSpec/gemSpec_Perf/gemSpec_Perf_V2.48.0/#A_23118-02
