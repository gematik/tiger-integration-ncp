...
Funktionalität: NCPeH PSA Rohdaten Performance Reporting
  ...
  @AFO-ID:A_22000 @AFO-ID:A_22002 @AFO-ID:A_22004 @AFO-ID:A_21975 @AFO-ID:A_22001-01
  @AFO-ID:A_21980
  ...
  @STATUS:Spezifiziert @MODUS:Halbautomatisch @PRIO:2 @TESTFALL:Positiv @TESTSTUFE:3
  @AFO-ID:A_22482 @AFO-ID:A_22000 @AFO-ID:A_22002 @AFO-ID:A_21975 @AFO-ID:A_22001-01
  @AFO-ID:A_22429
  # Weitere Tags, team-intern
  @IOP
  ...
  @AFO-ID:A_22482 @AFO-ID:A_22000 @AFO-ID:A_22002 @AFO-ID:A_22004 @AFO-ID:A_21975 @AFO-ID:A_22001-01
  @AFO-ID:A_23012 @AFO-ID:A_23013-01 @AFO-ID:A_23118-02
  @AFO-ID:A_23016-01
  # Weitere Tags, team-intern
  @IOP
  ...
  Szenario: NCPeH - PSA PerfRep Messung für Aufbau VAU-Kanal
    ...
    Angenommen der Testfall NCP1_IOP_PSA_EPA_060 wurde zu einem bekannten Zeitpunkt ausgeführt
    Und die Daten der Performance Use Cases aus dem Testfall sind bekannt
      | country     | PerformanceUsecases                            |
      | NETHERLANDS | NCPeH.UC_1,NCPeH.UC_2,NCPeH.UC_VAU1,NCPeH.UC_4 |
    Wenn zu dem Zeitintervall zeitlich passende Performance Reports an den BDEv2 Dienst geliefert wurden
    Dann enthält der Performance Report je einen Eintrag für jeden erwarteten Performance Use Case
    Und das Statusfeld enthält je erwartetem Eintrag einen korrekten Statuscode
      | Statuscode |
